<!-- ws:dev-reference source=wrightstrategy/bridge:conventions/dev-reference.md version=1 sha256=89289535658a782ca294e7f41842270cd6bf320130461df7dcfdb33c86c64bb7 -->
...
`wrightstrategy/bridge` (`container-build`, `release`, `osv-scan`, and `lockfile-refresh`). Their
